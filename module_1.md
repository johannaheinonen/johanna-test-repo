...
- Guest operating system: Debian 13.x (Trixie)
...
In this example __debian-live-13.6.0-amd64-xfce.iso__ will be used (but the instructions are valid for all 13.x versions). It can be downloaded from here: https://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/ (scroll down the page and find __debian-live-13.6.0-amd64-xfce.iso__ from the list).  
Direct link: https://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/debian-live-13.6.0-amd64-xfce.iso  

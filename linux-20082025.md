...
3) Real Installation
First the VM need to be rebooted in order got back to Live Boot Menu:
- in the terminal type: reboot
- in the top right corner click 'debian live user' and 'shutdown'. Start the VM from virtual box as explained above.  

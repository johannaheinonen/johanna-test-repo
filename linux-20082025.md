...
- select language: __English__  
- select your location: __Helsinki__ (time zone)  
- configure locales: __en-US.UTF-8__ (character encodings, how to represent text in computers)  
- configure the keyboard: __finnish__
  
- configure the network - hostname: linux-test
- configure the network - domain: example.com
  
- setup users and passwords - root password will __not__ be configured, this will be __left empty__  
- setup users and passwords - full name of the new user: your name (first_name, Last_name)  
- setup users and passwords - username of your account: your first name  
- setup users and passwords - choose a password for the new user: __use strong password here__
  
- partition disks - partitioning method: __guided - use entire disk__  
- partition disks - select disk to partition: select the virtual disk you created for your VM (probably the only option available)
...
- installation complete - please choose continue to reboot
